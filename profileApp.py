                ...
                content=ft.Column(
                    ...
                    controls=[
                        ...
                        ft.Container(
                            ...
                            image_src="https://avatars.githubusercontent.com/u/72348929?v=4",
                            image_fit="cover",
                            shadow=ft.BoxShadow(
                                spread_radius=6,
                                blur_radius=20,
                        ...
                        ft.Text(
                            "Python Programming | Machine Learning | Web Apps",
                            weight="w400",
                            text_align="center",
                        ),
                        ...
                        ft.Column(
                            ...
                            controls=[
                                ...
                                Link("Name", "Mihir Pesswani", self.page),
                                Link("GitHub", "@codemike513", self.page),
                                Link("Email", "pesswani.mihir@gmail.com", self.page),
                            ],
                        ),
                    ],
                ),
